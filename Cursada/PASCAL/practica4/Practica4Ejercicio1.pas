...
comprendidos entre los dos valores recibidos (sin incluir). }
  ...
  begin
    ...
    if (a = nil) then total:= 0
            else  if (( codigo1 < a^.dato.codigo ) and ( codigo2 > a^.dato.codigo)) then 
                      begin
                             total:= total +  a^.dato.montoTotal;
                             total:= total +  ObtenerMontoTotalEntreDosCodigos(a^.hi,codigo1,codigo2); 
                             total:= total +  ObtenerMontoTotalEntreDosCodigos(a^.hd,codigo1,codigo2); 
                       end
                                               else  if (codigo1 >= a^.dato.MontoTotal) then total:= total + ObtenerMontoTotalEntreDosCodigos(a^.hi,codigo1,codigo2) 
                                                                  else total:= total + ObtenerMontoTotalEntreDosCodigos(a^.hd,codigo1,codigo2);
                                 
                 
                 
   ObtenerMontoTotalEntreDosCodigos:= total;
